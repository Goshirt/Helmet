	...
	function submitBlog(){
		...
		if (title==null || title=="") {
			...
			$.post("${pageContext.request.contextPath}/admin/blog/save.do",
					{"title":title,"blogType.typeId":blogTypeId,"contentNoTag":contentNoTag,"content":content,"summary":UE.getEditor('editor').getContentTxt().substr(0,155),"keyWord":keyWord},
					function(result){
						if (result.success) {
...
<div id="panel" class="easyui-panel" title="编写博客" style="padding: 10px">
